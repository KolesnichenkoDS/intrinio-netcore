...
namespace Intrinio.Model
{
    ...
    public partial class
        AccumulationDistributionIndexTechnicalValue : IEquatable<AccumulationDistributionIndexTechnicalValue>,
            IValidatableObject
    {
        /// <summary>
        ...
        public AccumulationDistributionIndexTechnicalValue(DateTime? DateTime = default(DateTime?),
            float? Adi = default(float?))
        {
